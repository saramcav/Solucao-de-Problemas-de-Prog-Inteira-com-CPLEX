...
void read_input_file(const string& input_file, set<int>& V, set<pair<int, int>>& E, int& n, int& m) {
...
void print_and_write_result(IloCplex& solver, string input_file, double total_time, int n, IloArray<IloBoolVarArray>& x) {
